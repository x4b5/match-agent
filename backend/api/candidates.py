...
from backend.services.agents import profileer_kandidaat, extract_text_sync, genereer_embedding, verrijk_kandidaat_profiel
...
async def enrich_profile(name: str, req: EnrichRequest, background_tasks: BackgroundTasks):
    """Verrijk een kandidaatprofiel met nieuwe Q&A antwoorden."""
    ...
    nieuw_profiel = await verrijk_kandidaat_profiel(profiel_json, antwoorden_json, ruwe_tekst)
